                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        Provider.of<LanguageViewModel>(context).getText('driver_requested_end_ride'),
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton(
                              ...
                              child: Text(Provider.of<LanguageViewModel>(context).getText('reject')),
                            ),
                          ),
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              child: Text(Provider.of<LanguageViewModel>(context).getText('approve')),
                            ),
                          ),
                        ],
                      )
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 4),
                                      Text(
                                        "${Provider.of<LanguageViewModel>(context).getText('referral_discount_applied')} (-₹${vm.rideDetails!.discountAmount.toInt()})",
